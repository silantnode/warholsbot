...
bot.on(['/start', '/back'], msg => {
  ...
  let markup = bot.keyboard([
    ['/buttons', '/inlineKeyboard'], /* This tells me that buttons are best formatted in blocks of two. In any case the brackets represent blocks of buttons. If I wanted a column of buttons I would have to put each button it its own bracket. */
    ['/start','/hide']
  ], { resize: true });
